...
class FollowUserTest extends BaseTestCase
{
    ...
    /** @test */
    public function authenticated_user_can_post_a_request_to_follow_another_user()
    {
    ...
    /** @test */
    public function unauthenticated_users_can_not_post_follow_request()
    {
        $user = $this->createUser();
    ...
    /** @test */
    public function unauthenticated_users_can_not_send_unfollow_request()
    {
        $user = $this->createUser();
    ...
    /** @test */
    public function authenticated_users_can_send_unfollow_request()
    {
        $user = $this->createUser();
        $requestUser = $this->createUserWithValidToken();
