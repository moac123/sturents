...
class ArticleUpdateTest extends BaseTestCase
{

    use UseDatabaseTrait;

    /** @test */
    public function authenticated_user_may_update_an_article()
    {
    ...
    public function only_the_owner_of_the_article_can_update_the_article()
    {
        ...
        $response = $this->request('DELETE', "/api/articles/$article->slug", $payload, $headers);
